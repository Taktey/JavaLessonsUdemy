...
public class Operators {
    public float sum(float firstValue, float secondValue){return firstValue+secondValue;}
    public float subtraction(float firstValue, float secondValue){return firstValue-secondValue;}
    public float multiplication(float firstValue, float secondValue){return firstValue*secondValue;}
    public float division(float firstValue, float secondValue){return firstValue/secondValue;}
    ...
    public static void main(String[] args){
        ...
        switch (action){
            ...
            case ("/"):
                ...
                break;
            default:System.out.println("Error, operator hasn't been selected, try again");
        }
